...
const sizes = { sm: "3xl:p-[10px] lg:p-[6px] xl:p-[8px] p-[9px]" };
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#2e1739",
              "&:hover": { backgroundColor: "#2e1739", color: "#ffffff" },
            }),
...
SelectBox.propTypes = {
  ...
  shape: PropTypes.oneOf(["RoundedBorder5", "RoundedBorder17"]),
