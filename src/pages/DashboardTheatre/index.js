                    ...
                    <Column className="justify-start 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] w-[99%]">
                      ...
                      <Row className="items-start lg:ml-[14px] xl:ml-[18px] 2xl:ml-[21px] 3xl:ml-[25px] lg:mt-[29px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] w-[92%]">
                        ...
                        <Stack className="3xl:h-[115px] lg:h-[68px] xl:h-[85px] 2xl:h-[96px] lg:ml-[51px] xl:ml-[64px] 2xl:ml-[72px] 3xl:ml-[86px] w-[15%]">
                          <Column className="absolute bg-bluegray_900 items-center justify-start lg:p-[10px] xl:p-[13px] 2xl:p-[15px] 3xl:p-[18px] rounded-radius10 top-[0] w-[100%]">
                            <Text
                          ...
                          <div className="absolute bg-bluegray_900 bottom-[0] lg:h-[22px] xl:h-[27px] 2xl:h-[31px] 3xl:h-[37px] w-[100%]"></div>
                        </Stack>
                      </Row>
                      <Column className="bg-orange_50 border-bluegray_900 border-bw3 border-solid items-center justify-start pl-[1px] pt-[1px] rounded-radius20 w-[100%]">
                        <Column className="items-center justify-start lg:mt-[30px] xl:mt-[38px] 2xl:mt-[43px] 3xl:mt-[51px] w-[100%]">
                          <Column className="justify-start w-[96%]">
                            <Row className="items-start justify-between w-[100%]">
                              ...
                              <Input
                                ...
                                suffix={
                                  <Img
                                    src="images/img_calendar_32X50.svg"
                                    className="border-bluegray_900 border-2 border-solid bg-orange_100 lg:w-[35px] xl:w-[44px] 2xl:w-[50px] 3xl:w-[60px] rounded-radius5 my-[auto] mx-[1px]"
                                    alt="calendar"
                                  />
                                }
                                shape="RoundedBorder5"
                                variant="OutlineBluegray900_2"
                              ></Input>
                              <SelectBox
                                className="font-semibold mt-[2px] lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[18px] text-bluegray_900_b2 w-[19%]"
                                placeholderClassName="text-bluegray_900_b2"
                            ...
                            <Row className="items-start mt-[2px] w-[79%]">
                              <Column className="bg-bluegray_900 items-center justify-start xl:pb-[12px] 2xl:pb-[14px] 3xl:pb-[16px] lg:pb-[9px] rounded-bl-[10px] rounded-br-[10px] rounded-tl-[0] rounded-tr-[0] shadow-bs4 w-[24%]">
                                <Column className="border border-red_600_99 border-solid items-center justify-start lg:p-[4px] xl:p-[5px] 2xl:p-[6px] 3xl:p-[7px] w-[100%]">
                                  <Text
                                ...
                                <Input
                                  ...
                                  variant="OutlineRed60099"
                                ></Input>
                              </Column>
                              <Column className="bg-bluegray_900 items-center justify-start lg:ml-[348px] xl:ml-[435px] 2xl:ml-[490px] 3xl:ml-[588px] xl:pb-[10px] 2xl:pb-[12px] 3xl:pb-[14px] lg:pb-[8px] rounded-bl-[10px] rounded-br-[10px] rounded-tl-[0] rounded-tr-[0] shadow-bs4 w-[22%]">
                                <Text
                                  className="border border-red_600_99 border-solid font-medium 2xl:pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] lg:pr-[24px] xl:pr-[31px] 2xl:pr-[35px] 3xl:pr-[42px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[8px] text-orange_51 w-[auto]"
                                  variant="body7"
                                >
                                  Participant
                                </Text>
                                <Text
                                  className="border border-red_600_99 border-solid font-medium 2xl:pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] lg:pr-[16px] xl:pr-[20px] 2xl:pr-[23px] 3xl:pr-[27px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[8px] text-orange_51 w-[auto]"
                                  variant="body7"
                                >
                                  Student Accompanist
                                </Text>
                                <Column className="border border-red_600_99 border-solid items-end justify-start 2xl:pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[8px] w-[100%]">
                                  <Text
                          ...
                          <Column className="bg-bluegray_900 justify-end xl:mt-[120px] 2xl:mt-[135px] 3xl:mt-[162px] lg:mt-[96px] lg:p-[18px] xl:p-[23px] 2xl:p-[26px] 3xl:p-[31px] rounded-bl-[20px] rounded-br-[20px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
                            <Button
                              ...
                              size="sm"
                            >
                              <div className="bg-transparent font-bold lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-bluegray_900">
                                Add Participants
                              </div>
                            </Button>
                          </Column>
...
export default DashboardTheatrePage;
